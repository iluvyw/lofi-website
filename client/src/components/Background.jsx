...
export default function Background({background}) {
    ...
    return (
        <div className="relative w-full h-full flex flex-row overflow-hidden">
            ...
            {background.map(item => <img src={item} alt="bg" className="relative w-full h-full flex-shrink-0 object-contain duration-500" style={{ transform: `translate3d(${-index * 100}%, 0, 0)` }} />)}
